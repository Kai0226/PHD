...
2. keypoints integrated CHAMP and text integrated CHAMP have been merged in 
https://github.com/Kai0226/Video-Generation/tree/main/third_party

3. It also include processing code of Calisthenic, which including RL (GROP), and multimodal encoders (Autoencoder, VAE and CLIP for text, semantic maps and optical flow)

4. the CHAMP models traind for Calisthenic video dataset have been sync to '/media/kai/f4b6c365-d543-4751-877a-3b5a123ac025/video_generation/output/youtube_new/Champ_new/output'

5. train, val, and test data in Kaya have been setteled well, 'train' and 'test' have been sycn to s3, but not val.

6. 'results' folder has not been sync to local PC yet.
